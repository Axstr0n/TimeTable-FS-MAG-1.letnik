...
// let allSubjects = [EMEPS, NPZ, ES, TP, TZ, ST, KT, IPK, KNS, VT, VD, MKE, MT, NOP, TO, MK, RS, PAP]; // ----- 1. semester
let allSubjects = [KNEM, PTMM, TRSM  ,  HTTM, KOOM, RDTM  ,  OBTM, NNTM, GSPM  ,  DSKM, AKMM, PRSM  ,  NPPM, POPM, MSSM  ,  LSSM, FLIM, DKSM]; // ----- 2. semester
